...
if ($_GET['query'] == "newQuery"){		
	...
	if ( ($activityType == "All Activities/Sights") && ($fromDate == $today) && ($toDate == $today) //0 0 0 0 0 0 - 1 checked
	   && ($activityName == "Null") && ($partnerGender == "b")  && ($partnerCountry == "Null") ){
		$query = $regularQuery . $dateQuery00 . $endQuery;
		$queryNum = '1';
	}
	   
	elseif ( ($activityType == "All Activities/Sights") && ($fromDate == $today) && ($toDate == $today) //0 0 0 0 0 1 - 2 checked
	   && ($activityName == "Null") && ($partnerGender == "b")  && ($partnerCountry != "Null") ){
	   	$query = $regularQuery . $dateQuery00 . $countryQuery . $endQuery;
		$queryNum = '2';
	}
	   
	elseif  ( ($activityType == "All Activities/Sights") && ($fromDate == $today) && ($toDate == $today) //0 0 0 0 1 0 - 3 checked
	   && ($activityName == "Null") && ($partnerGender != "b")  && ($partnerCountry == "Null") ){
	   	$query = $regularQuery .$dateQuery00 .  $genderQuery . $endQuery;
	   	$queryNum = '3';
	}
	
	elseif  ( ($activityType == "All Activities/Sights") && ($fromDate == $today) && ($toDate == $today) //0 0 0 0 1 1 - 4 checked
	   && ($activityName == "Null") && ($partnerGender != "b")  && ($partnerCountry != "Null") ){
	   	$query = $regularQuery .$dateQuery00 . $genderQuery. $countryQuery. $endQuery;
		$queryNum = '4';
	}
	   
	elseif  ( ($activityType == "All Activities/Sights") && ($fromDate == $today) && ($toDate == $today) //0 0 0 1 0 0 - 5 checked
	   && ($activityName != "Null") && ($partnerGender == "b")  && ($partnerCountry == "Null") ){
	   	$query = $regularQuery .$dateQuery00 .  $actNameQuery. $endQuery;
		$queryNum = '5';
	}
	   
	elseif  ( ($activityType == "All Activities/Sights") && ($fromDate == $today) && ($toDate == $today) //0 0 0 1 0 1 - 6 checked
	   && ($activityName != "Null") && ($partnerGender == "b")  && ($partnerCountry != "Null") ){
	   	$query = $regularQuery .$dateQuery00 .  $actNameQuery . $countryQuery . $endQuery;
		$queryNum = '6';
	}
	
	elseif  ( ($activityType == "All Activities/Sights") && ($fromDate == $today) && ($toDate == $today) //0 0 0 1 1 0 - 7 checked
	   && ($activityName != "Null") && ($partnerGender != "b")  && ($partnerCountry == "Null") ){
	   	$query = $regularQuery . $dateQuery00 . $actNameQuery .$genderQuery . $endQuery;
		$queryNum = '7';
	}
	   
	elseif  ( ($activityType == "All Activities/Sights") && ($fromDate == $today) && ($toDate == $today) //0 0 0 1 1 1 - 8 checked
	   && ($activityName != "Null") && ($partnerGender != "b")  && ($partnerCountry != "Null") ){
	   	$query = $regularQuery . $dateQuery00 . $actNameQuery .$genderQuery . $countryQuery . $endQuery;
		$queryNum = '8';
	}
	   
	elseif  ( ($activityType == "All Activities/Sights") && ($fromDate == $today) && ($toDate != $today) //0 0 1 0 0 0 - 9 checked
	   && ($activityName == "Null") && ($partnerGender == "b")  && ($partnerCountry == "Null") ){
	   	$query = $regularQuery .$dateQuery01 . $endQuery;
		$queryNum = '9';	
	}
	   
	elseif  ( ($activityType == "All Activities/Sights") && ($fromDate == $today) && ($toDate != $today) //0 0 1 0 0 1 - 10 checked
	   && ($activityName == "Null") && ($partnerGender == "b")  && ($partnerCountry != "Null") ){
		$query = $regularQuery .$dateQuery01 . $countryQuery  . $endQuery;
		$queryNum = '10';	   	
	}
	   
	elseif  ( ($activityType == "All Activities/Sights") && ($fromDate == $today) && ($toDate != $today) //0 0 1 0 1 0 - 11 checked
	   && ($activityName == "Null") && ($partnerGender != "b")  && ($partnerCountry == "Null") ){
	   	$query = $regularQuery .$dateQuery01 . $genderQuery.  $endQuery;
		$queryNum = '11';
	}
	   
	elseif  ( ($activityType == "All Activities/Sights") && ($fromDate == $today) && ($toDate != $today) //0 0 1 0 1 1 - 12 checked
	   && ($activityName == "Null") && ($partnerGender != "b")  && ($partnerCountry != "Null") ){
	   	$query = $regularQuery .$dateQuery01 . $genderQuery.$countryQuery . $endQuery;
		$queryNum = '12';
	}
	   
	elseif  ( ($activityType == "All Activities/Sights") && ($fromDate == $today) && ($toDate != $today) //0 0 1 1 0 0 - 13 checked
	   && ($activityName != "Null") && ($partnerGender == "b")  && ($partnerCountry == "Null") ){
	   	$query = $regularQuery .$dateQuery01 . $actNameQuery . $endQuery;
		$queryNum = '13';
	}
	   
	elseif  ( ($activityType == "All Activities/Sights") && ($fromDate == $today) && ($toDate != $today) //0 0 1 1 0 1 - 14 checked
	   && ($activityName != "Null") && ($partnerGender == "b")  && ($partnerCountry != "Null") ){
	   	$query = $regularQuery .$dateQuery01 . $actNameQuery. $countryQuery . $endQuery;
		$queryNum = '14';
	}
	
	elseif  ( ($activityType == "All Activities/Sights") && ($fromDate == $today) && ($toDate != $today) //0 0 1 1 1 0 - 15 checked
	   && ($activityName != "Null") && ($partnerGender != "b")  && ($partnerCountry == "Null") ){
	   	$query = $regularQuery .$dateQuery01 . $actNameQuery. $genderQuery . $endQuery;
		$queryNum = '15';
	}
	   
	elseif  ( ($activityType == "All Activities/Sights") && ($fromDate == $today) && ($toDate != $today) //0 0 1 1 1 1 - 16 checked
	   && ($activityName != "Null") && ($partnerGender != "b")  && ($partnerCountry != "Null") ){
	   	$query = $regularQuery .$dateQuery01 . $actNameQuery. $genderQuery . $countryQuery  . $endQuery;
		$queryNum = '16';	
	}
	
	elseif  ( ($activityType == "All Activities/Sights") && ($fromDate != $today) && ($toDate == $today) //0 1 0 0 0 0 - 17 checked
	   && ($activityName == "Null") && ($partnerGender == "b")  && ($partnerCountry == "Null") ){
		$query = $regularQuery .$dateQuery10 . $endQuery;
		$queryNum = '17';	   	
	}
	
	elseif  ( ($activityType == "All Activities/Sights") && ($fromDate != $today) && ($toDate == $today) //0 1 0 0 0 1 - 18 checked
	   && ($activityName == "Null") && ($partnerGender == "b")  && ($partnerCountry != "Null") ){
	   	$query = $regularQuery .$dateQuery10 . $countryQuery . $endQuery;
		$queryNum = '18';
	   }
	
	elseif  ( ($activityType == "All Activities/Sights") && ($fromDate != $today) && ($toDate == $today) //0 1 0 0 1 0 - 19 checked
	   && ($activityName == "Null") && ($partnerGender != "b")  && ($partnerCountry == "Null") ){
	   	$query = $regularQuery .$dateQuery10 . $genderQuery . $endQuery;
		$queryNum = '19';	
	}
	
	elseif  ( ($activityType == "All Activities/Sights") && ($fromDate != $today) && ($toDate == $today) //0 1 0 0 1 1 - 20 checked
	   && ($activityName == "Null") && ($partnerGender != "b")  && ($partnerCountry != "Null") ){
	   	$query = $regularQuery .$dateQuery10 . $genderQuery. $countryQuery . $endQuery ;
		$queryNum = '20';
	}
	
	elseif  ( ($activityType == "All Activities/Sights") && ($fromDate != $today) && ($toDate == $today) //0 1 0 1 0 0 - 21 checked
	   && ($activityName != "Null") && ($partnerGender == "b")  && ($partnerCountry == "Null") ){
	   	$query = $regularQuery .$dateQuery10 . $actNameQuery. $endQuery;
		$queryNum = '21';
	}
	
	elseif  ( ($activityType == "All Activities/Sights") && ($fromDate != $today) && ($toDate == $today) //0 1 0 1 0 1 - 22 checked
	   && ($activityName != "Null") && ($partnerGender == "b")  && ($partnerCountry != "Null") ){
	   	$query = $regularQuery .$dateQuery10 . $actNameQuery. $countryQuery. $endQuery;
		$queryNum = '22';
	}
	
	elseif  ( ($activityType == "All Activities/Sights") && ($fromDate != $today) && ($toDate == $today) //0 1 0 1 1 0 - 23 checked
	   && ($activityName != "Null") && ($partnerGender != "b")  && ($partnerCountry == "Null") ){
	   	$query = $regularQuery .$dateQuery10 . $actNameQuery. $genderQuery . $endQuery;
		$queryNum = '23';
	}
	
	elseif  ( ($activityType == "All Activities/Sights") && ($fromDate != $today) && ($toDate == $today) //0 1 0 1 1 1 - 24 checked
	   && ($activityName != "Null") && ($partnerGender != "b")  && ($partnerCountry != "Null") ){
	   	$query = $regularQuery .$dateQuery10 . $actNameQuery. $genderQuery . $countryQuery. $endQuery;
		$queryNum = '24';
	}
	
	elseif  ( ($activityType == "All Activities/Sights") && ($fromDate != $today) && ($toDate != $today) //0 1 1 0 0 0 - 25 checked
	   && ($activityName == "Null") && ($partnerGender == "b")  && ($partnerCountry == "Null") ){
	   	$query = $regularQuery .$dateQuery11. $endQuery;
		$queryNum = '25';
	}
	
	elseif  ( ($activityType == "All Activities/Sights") && ($fromDate != $today) && ($toDate != $today) //0 1 1 0 0 1 - 26 checked
	   && ($activityName == "Null") && ($partnerGender == "b")  && ($partnerCountry != "Null") ){
	   	$query = $regularQuery .$dateQuery11.$countryQuery. $endQuery;
		$queryNum = '26';
	}	   
	elseif  ( ($activityType == "All Activities/Sights") && ($fromDate != $today) && ($toDate != $today) //0 1 1 0 1 0 - 27 checked
	   && ($activityName == "Null") && ($partnerGender != "b")  && ($partnerCountry == "Null") ){
	   	$query = $regularQuery .$dateQuery11.$genderQuery. $endQuery;
		$queryNum = '27';
	}
	
	elseif  ( ($activityType == "All Activities/Sights") && ($fromDate != $today) && ($toDate != $today) //0 1 1 0 1 1 - 28 checked
	   && ($activityName == "Null") && ($partnerGender != "b")  && ($partnerCountry != "Null") ){
	   	$query = $regularQuery .$dateQuery11.$genderQuery. $countryQuery.$endQuery;
		$queryNum = '28';
	}
	
	elseif  ( ($activityType == "All Activities/Sights") && ($fromDate != $today) && ($toDate != $today) //0 1 1 1 0 0 - 29 checked
	   && ($activityName != "Null") && ($partnerGender == "b")  && ($partnerCountry == "Null") ){
	    $query = $regularQuery .$dateQuery11. $actNameQuery . $endQuery;
		$queryNum = '29';	
	}
	
	elseif  ( ($activityType == "All Activities/Sights") && ($fromDate != $today) && ($toDate != $today) //0 1 1 1 0 1 - 30 checked
	   && ($activityName != "Null") && ($partnerGender == "b")  && ($partnerCountry != "Null") ){
	...
	elseif  ( ($activityType != "All Activities/Sights") && ($fromDate != $today) && ($toDate != $today) //1 1 1 1 1 0- 63
	   && ($activityName != "Null") && ($partnerGender != "b")  && ($partnerCountry == "Null") ){
	   		$query = $regularQuery. $dateQuery11 .$actTypeQuery. $actNameQuery.$genderQuery . $endQuery;
			$queryNum = '63';
	}
