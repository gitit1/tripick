...
$query = mysqli_query($conn_users, $tbl_users);
if ($query === TRUE) {
...
$query = mysqli_query($conn_users, $tbl_useroptions); 
if ($query === TRUE) {
...
$query = mysqli_query($conn_users, $tbl_friends); 
if ($query === TRUE) {
...
$query = mysqli_query($conn_users, $tbl_blockedusers); 
if ($query === TRUE) {
...
$query = mysqli_query($conn_users, $tbl_status); 
if ($query === TRUE) {
...
$query = mysqli_query($conn_users, $tbl_photos); 
if ($query === TRUE) {
...
$query = mysqli_query($conn_users, $tbl_notifications); 
if ($query === TRUE) {
