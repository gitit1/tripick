...
if ($_GET['id'] == "friends"){
	...
	if($friend_count < 1){
		...
		while($row = mysqli_fetch_array($query, MYSQLI_ASSOC)) {
			...
			$friendsHTML .= '<a href="mypage.php?id=profile&u='.$friend_username.'"><img class="mypageFriendsSectionAvatar" src="'.$friend_pic.'" alt="'.$friend_username.'" title="'.$friend_username.'">
							 <label class="frdSecLblFrd">'.$friend_username.'</label></a>';				
